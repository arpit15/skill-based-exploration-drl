...
# transfer
pos_data = np.loadtxt(expanduser("~/pred_models/transfer-v0/run1/transfer-v0_pos.csv"), delimiter=',')
...
np.savetxt(expanduser("~/pred_models/transfer-v0/run1/transfer-v0_data.csv"), grasping_data, delimiter=',')
