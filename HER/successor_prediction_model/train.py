...
def run(env_id, render, num_ep, log_dir, restore_dir, skillset, commit_for, skillname, 
	...
	with U.single_threaded_session() as sess:
		actor_model = DDPGSkill(observation_shape= observation_shape, nb_actions = env.action_space.shape[-1])
